 ...
 */
class EM_Ajaxcart_Helper_Product_View extends Mage_Core_Helper_Abstract
{
    ...
    public function initProductLayout($product, $controller)
    {
        ...
        $update->addHandle('AJC_PRODUCT_TYPE_' . $product->getTypeId());
    ...
    public function prepareAndRender($productId, $controller, $params = null)
    {
		...
		$arr['options']	=	1;
		$arr['html']	=	$controller->getLayout()->getBlock("content")->toHtml();
