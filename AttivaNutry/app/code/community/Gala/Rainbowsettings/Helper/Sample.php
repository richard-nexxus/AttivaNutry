<?php
class Gala_Rainbowsettings_Helper_Sample extends Mage_Core_Helper_Abstract
{
	protected $_themeSlug  = 'default/galarainbow';
	...
	protected $_megaMenuModel = 'rainbowsettings/megamenupro';
	protected $_themeFrameworkAreaModel = 'themeframework/area';
	
	public function importSampleData($installer){
		$installer->startSetup();
		$pathFile = Mage::getBaseDir('var').DS.'install_galarainbow.txt';
		if(file_exists($pathFile)){
			echo 'Installing Gala Rainbow theme, please come back in some minutes ...';
			exit;
		}
		file_put_contents($pathFile,'Installing EM0075 theme');
