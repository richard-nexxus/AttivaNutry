<?php
class Gala_Rainbowsettings_Adminhtml_Rainbowsettings_ThemeController extends Mage_Adminhtml_Controller_Action
{
	protected $_prefixBlock = 'galarainbow_';
	protected $_prefixPage = 'galarainbow_';
	protected $_packageTheme = 'default/galarainbow';
	...
	/*
		...
		@param : string $prefix (EX: galarainbow/default)
